    ...
    <style>
        ...
        * {
        ...
        .header {
            ...
            grid-auto-flow: row;
            grid-template-areas:
                "LogoAndText LogoAndText LogoAndText Photo Photo"
                "RSBSANo RSBSANo RSBSANo Photo Photo";
            min-height: 200px;
        }

        .logo-and-text {
            grid-area: LogoAndText;
            display: flex;
            align-items: center;
            gap: 15px;
        }
...
<body>
    <!-- Restructured header with grid layout -->
    <div class="header">
        <div class="logo-and-text">
            <div class="logo-placeholder">
                ...
                @endphp
                @if($logoSrc)
                    <img src="{{ $logoSrc }}" style="width: 80px; height: 80px; object-fit: contain;" alt="DA Logo">
                @endif
            </div>
    ...
    <div class="section">
        ...
        <div class="section-content">
            <div class="form-row">
                ...
                <div class="form-value">{{ $enrollment->surname }}, {{ $enrollment->first_name }} {{ $enrollment->middle_name }} {{ $enrollment->extension_name }}</div>
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-grid-item" style="width: 40%;">
                    ...
                    <span class="form-grid-value">{{ $enrollment->date_of_birth ? $enrollment->date_of_birth->format('F d, Y') : 'N/A' }}</span>
                </div>
    ...
    <div class="section">
        ...
        <div class="section-content">
            ...
            <div class="form-row">
                ...
                <div class="form-value">{{ $enrollment->government_id_type }} - {{ $enrollment->government_id_number }}</div>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="section-content">
            ...
            <div style="margin-top: 10px;">
                <div style="font-weight: 600; color: #333; font-size: 8.5pt; margin-bottom: 5px;">Gross Annual Income:</div>
                ...
                <div class="parcel-content">
                    <div class="form-grid">
                        <div class="form-grid-item" style="width: 40%;">
                            ...
                            <span class="form-grid-value"><strong>{{ $parcel->total_farm_area_ha }} hectares</strong></span>
                        </div>
                        <div class="form-grid-item" style="width: 35%;">
                            <span class="form-grid-label">Ownership Type:</span>
                            <span class="form-grid-value">{{ ucfirst(str_replace('_', ' ', $parcel->ownership_type ?? 'N/A')) }}</span>
                        </div>
